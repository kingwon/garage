...
<!--                         <dl>
 ...
 <h1>维修项目</h1>
<div class="optbtn">
    <a class="btn btn-info" href="<?php echo U('Type/add');?>">新增项目</a>
</div>
...
<div class="row" id="list-grid">
    <table class="table table-bordered table-hover table-grid">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($val["type_describe"]); ?></td>
                <td><?php echo ($val["type_base_charge"]); ?></td>
                <td><a href="<?php echo U('type/edit', 'type_id=' . $val['type_id']);?>">编辑</a></td>
