...
class Page{
    ...
    private $config  = array(
        ...
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
        'theme'  => '<div class="page"><ul class="pagination">%HEADER% %FIRST% %UP_PAGE% %LINK_PAGE% %DOWN_PAGE% %END%</ul></div>',
    );
    ...
    public function show() {
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        // var_dump(array($this->config['header'], $this->nowPage, $up_page, $down_page, $the_first, $link_page, $the_end, $this->totalRows, $this->totalPages));
